...
export class Calculator extends React.Component {
    ...
    _calc() {
        if (this.curNum.length > 0 && this.prvNum.length > 0 && this.operator !== null) {
            ...
            var result = 0;
            let n1 = Number(this.prvNum);
            let n2 = Number(this.curNum);
            if (this.operator === '+') result = n1 + n2;
